...
function obtenerPreguntas($conexion) {
    $result = $conexion->query("SELECT * FROM preguntas_fisica");
...
function crearPregunta($conexion, $enunciado, $respuesta_correcta, $respuesta_incorrecta1, $respuesta_incorrecta2, $respuesta_incorrecta3) {
    $stmt = $conexion->prepare("INSERT INTO preguntas_fisica (enunciado, respuesta_correcta, respuesta_incorrecta1, respuesta_incorrecta2, respuesta_incorrecta3) VALUES (?, ?, ?, ?, ?)");
...
function actualizarPregunta($conexion, $id, $enunciado, $respuesta_correcta, $respuesta_incorrecta1, $respuesta_incorrecta2, $respuesta_incorrecta3) {
    $stmt = $conexion->prepare("UPDATE preguntas_fisica SET enunciado = ?, respuesta_correcta = ?, respuesta_incorrecta1 = ?, respuesta_incorrecta2 = ?, respuesta_incorrecta3 = ? WHERE id = ?");
...
function eliminarPregunta($conexion, $id) {
    $stmt = $conexion->prepare("DELETE FROM preguntas_fisica WHERE id = ?");
