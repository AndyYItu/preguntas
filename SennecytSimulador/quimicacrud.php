...
function obtenerPreguntas($conexion) {
    $result = $conexion->query("SELECT * FROM preguntas_quimica");
...
function crearPregunta($conexion, $enunciado, $respuesta_correcta, $respuesta_incorrecta1, $respuesta_incorrecta2, $respuesta_incorrecta3) {
    $stmt = $conexion->prepare("INSERT INTO preguntas_quimica (enunciado, respuesta_correcta, respuesta_incorrecta1, respuesta_incorrecta2, respuesta_incorrecta3) VALUES (?, ?, ?, ?, ?)");
...
function actualizarPregunta($conexion, $id, $enunciado, $respuesta_correcta, $respuesta_incorrecta1, $respuesta_incorrecta2, $respuesta_incorrecta3) {
    $stmt = $conexion->prepare("UPDATE preguntas_quimica SET enunciado = ?, respuesta_correcta = ?, respuesta_incorrecta1 = ?, respuesta_incorrecta2 = ?, respuesta_incorrecta3 = ? WHERE id = ?");
...
function eliminarPregunta($conexion, $id) {
    $stmt = $conexion->prepare("DELETE FROM preguntas_quimica WHERE id = ?");
...
<div class="form-container">
    <a href="salaadmin.php" class="boton-volver">Volver a Sala Admin</a>
    <h2>Crear Nueva Pregunta</h2>
    <form method="post" action="quimicacrud.php">
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                ...
                <form method="post" action="quimicacrud.php" onsubmit="return confirm('¿Estás seguro de que deseas eliminar esta pregunta?');">
