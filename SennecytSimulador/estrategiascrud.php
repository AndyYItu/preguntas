...
function obtenerPreguntas($conexion) {
    $result = $conexion->query("SELECT * FROM preguntas_estrategias");
...
function crearPregunta($conexion, $enunciado, $respuesta_correcta, $respuesta_incorrecta1, $respuesta_incorrecta2, $respuesta_incorrecta3) {
    $stmt = $conexion->prepare("INSERT INTO preguntas_estrategias (enunciado, respuesta_correcta, respuesta_incorrecta1, respuesta_incorrecta2, respuesta_incorrecta3) VALUES (?, ?, ?, ?, ?)");
...
function actualizarPregunta($conexion, $id, $enunciado, $respuesta_correcta, $respuesta_incorrecta1, $respuesta_incorrecta2, $respuesta_incorrecta3) {
    $stmt = $conexion->prepare("UPDATE preguntas_estrategias SET enunciado = ?, respuesta_correcta = ?, respuesta_incorrecta1 = ?, respuesta_incorrecta2 = ?, respuesta_incorrecta3 = ? WHERE id = ?");
...
function eliminarPregunta($conexion, $id) {
    $stmt = $conexion->prepare("DELETE FROM preguntas_estrategias WHERE id = ?");
...
<div class="form-container" style="text-align: left; margin-top: 20px;">
    ...
    <form method="post" action="estrategiacrud.php">
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                ...
                <form method="post" action="fisicacrud.php" onsubmit="return confirm('¿Estás seguro de que deseas eliminar esta pregunta?');">
...
<div id="formularioEdicion" style="display:none;">
    <form method="post" action="fisicacrud.php">
